...
const pausedOrdersRetriever = createSelector( // SELECTOR
...
const processOrderHandler = async (e: T ) => {
    ...
    <TabPanel value={"1"}>
         <Stack>
            {pausedOrders?.map((order: Order) => {     //order ni soni
                return (
    ...
    {!pausedOrders || (pausedOrders.length === 0 && ( //agar bunga true bersak PAUSED ORDERSDA no-image-list PAYDO BOLADI
